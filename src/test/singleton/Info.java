...
public class Info
{
     ...
     * in the java virtual machine. The singleton class must provide a global access point to get the instance of the
     * class. Singleton pattern is used for logging, drivers objects, caching and thread pool.
     * 
